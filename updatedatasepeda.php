...
if ($_SERVER['REQUEST_METHOD'] =='POST'){
    ...
    $sql = "UPDATE sepeda SET namasepeda='$namasepeda',kodesepeda='$kodesepeda',jenissepeda='$jenissepeda',merksepeda='$merksepeda',
     warnasepeda='$warnasepeda',hargasewa='$hargasewa' ,gambarsepeda ='$filename' WHERE id = '$id'";
